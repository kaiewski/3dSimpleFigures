...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.chkAxes = QCheckBox(Form)
        self.chkAxes.setObjectName(u"chkAxes")

        self.gridLayout.addWidget(self.chkAxes, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.chkAxes.setText(QCoreApplication.translate("Form", u"Axes on/off", None))
    # retranslateUi
